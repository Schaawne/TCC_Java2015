...
public class CardStack
{
    ...
    /** Total number of FlashCards in the Stack */
    ...
    public boolean AddCard(FlashCard newCard)
    {
        ...
        //If successful, make sure currentIndex is set and total count is incremented
        if(result)
        {
            if(0 > m_currentIndex)
            {
    ...
    {
        //Check if current index has not been initialized or has exceeded the bounds
