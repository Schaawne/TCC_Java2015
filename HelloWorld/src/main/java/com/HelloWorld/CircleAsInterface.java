...
/**
 * CircleAsInterface class for HelloWorld
 * <p>
 ...
 * @since 0.0.0.1
 */
public class CircleAsInterface implements ShapeInterface{
    ...
    /**
     * CircleAsInterface Constructor
     *
     * @param radius radius of circle
     * @param center center of circle
     */
    public CircleAsInterface(double radius, CartesianPoint center) {
        this.radius = radius;
        this.center = center;
    }
